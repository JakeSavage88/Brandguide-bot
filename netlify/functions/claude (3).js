// ════════════════════════════════════════════════════════════════
// ELEUSYS — /api/claude  v3.1  (Anthropic API proxy)
// V3.1 CHANGES:
//   · No logic change. Documents the model-string pairing added in
//     index.html v4.4.1: the front-end now calls CLAUDE_MODEL (one
//     constant, one place) instead of a literal repeated 7x. This
//     allowlist is the SERVER's independent check and is NOT
//     auto-synced from that constant — a Netlify function and a
//     browser bundle cannot literally share one JS variable. Bumping
//     CLAUDE_MODEL in index.html without adding the new string here
//     first will 400 every single call the moment it ships.
// V3 (retained) CHANGES:
...
// MUST include whatever CLAUDE_MODEL is set to in index.html — see note above.
